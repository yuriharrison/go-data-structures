...
func (bst *BinarySearchTree) Find(value int) IntEvaluable {
...
func (n *node) compare(value int) bool {
...
func (n *node) eq(value int) bool {
	return n.data.Value() == value
}

func (n *node) lt(value int) bool {
	return n.data.Value() < value
}

func (n *node) le(value int) bool {
	return n.data.Value() <= value
}

func (n *node) gt(value int) bool {
	return n.data.Value() > value
}

func (n *node) ge(value int) bool {
	return n.data.Value() >= value
}
